...
const BRODetails = () => {
    ...
    const [BRONationality, setBRONationality] = useState('');
    const [expirationDate, setExpirationDate] = useState('');
    const [relationship, setRelationship] = useState('');
    const [beneficiaryCivilIDNo, setBeneficiaryCivilIDNo] = useState('');
    const [address, setAddress] = useState('');
    const [profession, setProfession] = useState('');
    const [reasonOfBRO, setReasonOfBRO] = useState('');
    const [incomeWealthDetails, setIncomeWealthDetails] = useState('');
    ...
    const validateForm = () => {
        ...
        if (activeButton === "No" && !BRONationality.trim() ) {
            errors.BRONationality = "BRO Nationality is required";
        }
        if (activeButton === "No" && !beneficiaryName.trim() ) {
    ...
    const handleButtonClick = (event) => {
        ...
        if (event.target.innerText === "Yes") {
            setNext(false);
            delete errors.BRONationality;
            delete errors.beneficiaryName;
            delete errors.relationship;
            delete errors.beneficiaryCivilIDNo;
            delete errors.expirationDate;
            delete errors.reasonOfBRO;
            delete errors.address;
            delete errors.profession;
            delete errors.incomeWealthDetails;
            ...
            <div className="intro d-flex flex-column align-items-center">
                ...
                <form className="form" onSubmit={handleNext}>
                        ...
                        <>
                            <div className="form-group">
                                <input
                                    ...
                                    onChange={(e) => setBRONationality(e.target.value)}
                                    placeholder=""
                    ...
                    <div className="form-group">
                        <input
                            type="text"
                            value={beneficiaryCivilIDNo}
                            onChange={(e) => setBeneficiaryCivilIDNo(e.target.value)}
                            placeholder=""
                            className="form-control mb-3"
                        />
                    ...
                    <div className="form-group">
                        <input
                            type="text"
                            value={reasonOfBRO}
                            onChange={(e) => setReasonOfBRO(e.target.value)}
                            placeholder=""
                            className="form-control mb-3"
                        />
                    ...
                    <div className="form-group">
                        <input
                            type="text"
                            value={incomeWealthDetails}
                            onChange={(e) => setIncomeWealthDetails(e.target.value)}
                            placeholder=""
                            className="form-control mb-3"
                        />
