...
const PoliticalPosition = () => {
    ...
    const handleAddInput = (index) => {
        if (index === inputs.length - 1) { // Check if the first input is clicked and only one input exists
        ...
        <div id="PoliticalPosition" className="container align-items-center p-3">
            ...
            <div className="intro d-flex flex-column align-items-center">
                ...
                <form className="form" onSubmit={handleNext}>
                    ...
                    {currentPrevious === "Previous" && (
                        ...
                        <div className="form-group">
                            ...
                            <label className="floating-label">If previous, please specify Year of Retirement</label>
                                   ...
                                   {errors.yearOfRetirement && <div className="text-danger error">{errors.yearOfRetirement}</div>}</div> 
                    )}
                    <div className="form-group">
                        <input
                            type="text"
                    ...
                    <label className="custom-control-label" htmlFor="customCheck1">
                        If you or any of your first or second-degree relatives or close associate (partner/consultant/legal representative) are holding political position, 
